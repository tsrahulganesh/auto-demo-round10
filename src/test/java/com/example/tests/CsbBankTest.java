...
public class CsbBankLoginTest {
    ...
    @Test
    void loginAndVerifyAccountSummaryTitle() {
        ...
        try {
            ...
            new WebDriverWait(driver, Duration.ofSeconds(12))
                    .until(ExpectedConditions.titleContains("Account Summary - COMMUNITY STATE BANK"));
    ...
    private static void writeHtmlReport(File reportFile,
        ...
        // Write REAL HTML (do not escape structural tags)
    ...
    //    // Escape only dynamic content (fix double-escaping)
